...
** DONE Dissuade the bot from looking at hits taken
   ...
   :END:
** TODO Implement a dot-product version of the heuristic
** TODO Implement a bitset version of the engine
** TODO Don't use a prio queue for construction
** TODO Use Accelerate for the top-level vector calculations
